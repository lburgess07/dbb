...
| [Cross-Application Dependencies](Cross-Application-Dependencies/) | Sample | Sample configuration demonstrating zBuilder's cross-application dependency management feature. Includes the MortgageApplication split into five independently buildable sub-applications, covering multiple dependency types including source and generated artifacts. |
